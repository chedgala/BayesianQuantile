...
outdf_long <- outdf %>%
  pivot_longer(cols = c("mean_1", "mean_2", "mean_3", "mean_4", "mean_5",
                        "sd_1", "sd_2", "sd_3", "sd_4","sd_5"),
...
outdf_long$parameter <- factor(x = outdf_long$parameter,
                               levels = unique(outdf_long$parameter))
